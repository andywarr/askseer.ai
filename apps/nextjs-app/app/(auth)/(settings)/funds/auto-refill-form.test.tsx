...
describe("AutoRefillForm", () => {
  ...
  describe("Team Selection", () => {
    it("should render team selector with all teams", async () => {
      render(<AutoRefillForm teams={mockTeams} />);
    ...
    it("should auto-select team when only one team exists", async () => {
      ...
      render(<AutoRefillForm teams={singleTeam} />);
    ...
    it("should display balance with color coding", async () => {
      const user = userEvent.setup();
      render(<AutoRefillForm teams={mockTeams} />);
  ...
  describe("Form Inputs", () => {
    it("should display threshold and amount inputs", () => {
      ...
      expect(
        screen.getByLabelText("How much do you want to add?"),
      ).toBeInTheDocument();
    });
    ...
    it("should accept large threshold values", async () => {
      const user = userEvent.setup();
      render(<AutoRefillForm teams={mockTeams} />);
      ...
      expect(thresholdInput).toHaveValue(150);
    });

    it("should accept large amount values", async () => {
      const user = userEvent.setup();
      render(<AutoRefillForm teams={mockTeams} />);
    ...
    it("should calculate and display total cost", () => {
      ...
      // Default amount is 0, so total is $0.00
    ...
    it("should update total cost when amount changes", async () => {
      ...
      // Total is directly the dollar amount entered
  ...
  describe("Payment Method", () => {
    it("should show 'Add Payment Method' button when no payment method exists", async () => {
      ...
      render(<AutoRefillForm teams={[mockTeams[0]]} />);
