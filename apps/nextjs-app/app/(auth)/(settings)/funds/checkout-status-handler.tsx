  ...
  useEffect(() => {
    ...
    if (status === "success" && sessionId) {
      ...
      const toastId = toast.loading("Processing your payment...", {
        description: "Adding funds to your team",
      });
      ...
      fetch("/api/funds/verify", {
        ...
        .then(async (res) => {
          ...
          if (res.ok && data.success) {
            toast.success("Payment successful!", {
              id: toastId,
              description: `$${(data.amountCents / 100).toFixed(2)} has been added to your team`,
              duration: 5000,
            });
            ...
            toast.warning("Payment processed", {
              id: toastId,
              description:
                "Your funds should appear shortly. Refresh if needed.",
              duration: 5000,
            });
        ...
        .catch((error) => {
          ...
          toast.error("Verification failed", {
            id: toastId,
            description: "Please refresh the page to see your balance",
            duration: 5000,
          });
        })
        .finally(() => {
