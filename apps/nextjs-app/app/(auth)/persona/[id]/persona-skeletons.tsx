...
export function PersonaVersionsSkeleton() {
  return (
    <section className="pb-12 pl-0 md:pl-48" aria-label="Loading version history">
...
export function PersonaRelatedStudiesSkeleton() {
  return (
    <section className="pb-12 pl-0 md:pl-48" aria-label="Loading related studies">
...
export function PersonaSectionSkeleton({ itemCount = 6 }: { itemCount?: number }) {
  return (
    <section className="pb-10 pl-0 md:pl-48" aria-label="Loading section">
