    ...
    <div>
      {isBenchmark && (
        <div className="mb-4 rounded-lg border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-800 dark:border-blue-900 dark:bg-blue-950 dark:text-blue-200">
          ...
          {benchmarkMode === "persona"
            ? "Select a new persona to compare against the original evaluation. The flow and other settings are locked."
            : "Upload a new flow to compare against the original evaluation. The persona and other settings are locked."}
        </div>
      )}
      <Form {...form}>
        <form
