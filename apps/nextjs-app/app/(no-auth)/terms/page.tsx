    ...
    <div className="flex min-h-screen w-full flex-col">
      ...
      <div className="relative bg-gradient-to-b from-pink-100/30 via-white to-white">
        ...
        <div className="relative mx-auto flex max-w-5xl flex-col items-center p-8">
          <GlobalHeader activePage="terms" theme="light" />
      ...
      <div className="mx-auto flex max-w-5xl flex-col p-8">
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          We are Seer (&ldquo;Company,&rdquo; &ldquo;we,&rdquo;
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          (the &ldquo;Site&rdquo;), as well as any other related products and
          services that refer or link to these legal terms (the &ldquo;Legal
          Terms&rdquo;) (collectively, the &ldquo;Services&rdquo;).
        </p>
        <p className="mt-8 leading-7 not-first:mt-6">
          You can contact us by referring to the contact details at the bottom
          of this document.
        </p>
        <p className="mt-8 leading-7 not-first:mt-6">
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          upon posting or notifying you by info@askseer.ai, as stated in the
        ...
        <ol className="my-6 ml-6 list-decimal leading-7 [&>li]:mt-2">
          ...
          <li>
            <a href="#social-media" className="text-blue-600 hover:underline">
              Social media
            </a>
          </li>
          <li>
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          graphics in the Services (collectively, the &ldquo;Content&rdquo;), as
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          &ldquo;AS IS&rdquo; for your personal, non-commercial use or internal
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          please address your request to: contact@askseer.ai. If we ever grant
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          <a
            ...
            className="text-blue-600 hover:underline"
          >
            &ldquo;COPYRIGHT INFRINGEMENTS&rdquo;
          </a>{" "}
          section below.
        </p>
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          Stripe&apos;s terms and authorize us to share your email address with
          Stripe for the purpose of processing your payment and sending you a
          receipt.
        </p>
        <p className="mt-8 leading-7 not-first:mt-6">
        ...
        <ul className="my-6 ml-6 list-disc leading-7 [&>li]:mt-2">
          ...
          <li>
            ...
            interchange formats (&ldquo;gifs&rdquo;), 1×1 pixels, web bugs,
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          &ldquo;Contributions&rdquo;). Contributions may be viewable by other
          ...
          Services&rsquo; Privacy Policy. When you create or make available any
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          providers (each such account, a &ldquo;Third-Party Account&rdquo;) by
          ...
          in your Third-Party Account (the &ldquo;Social Network Content&rdquo;)
          ...
          the Social Network Content may no longer be available on and through
          ...
          our servers that was obtained through such a Third-Party Account,
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          the contact information provided below (a &ldquo;Notification&rdquo;).
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          at&nbsp;
          <a
            href="mailto:contact@askseer.ai"
            className="text-blue-600 hover:underline"
          >
            contact@askseer.ai
          </a>
