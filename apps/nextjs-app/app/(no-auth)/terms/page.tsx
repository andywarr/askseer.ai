  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-5xl flex-col p-8">
      ...
      <p className="mt-8 leading-7 not-first:mt-6">
        ...
        in the Services (collectively, the &ldquo;Content&rdquo;), as well as
      ...
      <ul className="my-6 ml-6 list-disc leading-7 [&>li]:mt-2">
        ...
        <li>
          Copy or adapt the Services&rsquo; software, including but not limited
      ...
      <p className="mt-8 leading-7 not-first:mt-6">
        ...
        service provider, the Social Network Content may no longer be available
