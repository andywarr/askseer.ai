      ...
      >
        ...
        >
          ...
          <div className="py-4 text-sm">
            <div className="pr-8 text-zinc-900 dark:text-zinc-100">
              <TranslationWrapper text={item.reason || ""} sourceLocale={studyLocale} />
            </div>
              ...
              <Card key={rec.id} className="pt-4">
                <CardContent>
                  <div className="text-sm text-zinc-900 dark:text-zinc-100">
                    <TranslationWrapper text={rec.recommendation} sourceLocale={studyLocale} />
                  </div>
                  {rec.source && (
