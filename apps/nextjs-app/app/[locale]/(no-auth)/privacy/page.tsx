    ...
    <div className="flex min-h-screen w-full flex-col">
      ...
      <div className="relative bg-gradient-to-b from-pink-100/30 via-white to-white">
        ...
        <div className="relative mx-auto flex max-w-5xl flex-col items-center p-8">
          <GlobalHeader activePage="privacy" theme="light" />
      ...
      <div className="mx-auto flex max-w-5xl flex-col p-8">
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          &ldquo;our&rdquo;), describes how and why we might collect, store,
          use, and/or share (&ldquo;process&rdquo;) your information when you
          use our services (&ldquo;Services&rdquo;), such as when you:
        </p>
        <ul className="my-6 ml-6 list-disc leading-7 [&>li]:mt-2">
          <li>
            Visit our website at askseer.ai, or any website of ours that links
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          still have any questions or concerns, please contact us referring to
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          third parties, as described in the section{" "}
        ...
        <ul className="my-6 ml-6 list-disc leading-7 [&>li]:mt-2">
          <li>
            ...
            system activity, error reports (sometimes called &ldquo;crash
            dumps&rdquo;), and hardware settings).
          </li>
          <li>
        ...
        <ul className="my-6 ml-6 list-disc leading-7 [&>li]:mt-2">
          ...
          <li>
            <strong>To process payments and send receipts.</strong> We may
            process your information to complete transactions, including sharing
            your email address with our payment processor (Stripe) to send you
            payment receipts.
          </li>
          <li>
        ...
        <ul className="my-6 ml-6 list-disc leading-7 [&>li]:mt-2">
          <li>
            ...
            any time. Contact us referring to the contact details at the bottom
            of this document to withdraw your consent.
          </li>
          <li>
        ...
        <ul className="my-6 ml-6 list-disc leading-7 [&>li]:mt-2">
          <li>
            <strong>Payment Processing.</strong> When you purchase credits or
            make payments through our Services, we share your email address with
            Stripe, our third-party payment processor, to process your
            transaction and send you payment receipts. Stripe&apos;s use of your
          ...
          <li>
            ...
            email service provider, to send transactional and communication
            emails to you. When we send you emails, your email address is shared
            with Resend to deliver those communications. Resend&apos;s use of
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          third-party social media account details (like your Google, Facebook
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          please contact us referring to the contact details at the bottom of
          this document.
        </p>
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          You can make such a request by contacting us referring to the contact
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          consent at any time by contacting us referring to the contact details
          at the bottom of this document or updating your preferences.
        </p>
        <p className="mt-8 leading-7 not-first:mt-6">
        ...
        <p className="mt-8 leading-7 not-first:mt-6">
          ...
          &ldquo;selling&rdquo; your personal information.
        </p>
        <p className="mt-8 leading-7 not-first:mt-6">
        ...
        <p className="mt-4 leading-7 not-first:mt-6">
          ...
          contacting us referring to the contact details at the bottom of this
          document. We will inform you in writing of any action taken or not
        ...
        <p className="mt-4 leading-7 not-first:mt-6">
          ...
          submit your request in writing to us by contacting us referring to the
          contact details at the bottom of this document.
        </p>
