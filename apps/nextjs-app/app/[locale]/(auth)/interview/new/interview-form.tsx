...
export function InterviewForm(props: InterviewFormProps) {
  ...
  const ti = useTranslations("StudyWizardForms.interview");
  ...
  const schema = useMemo(() => createInterviewSchema(tv), [tv]);
  ...
  const handleSubmitButtonClick = async (data: InterviewFormValues) => {
    ...
    try {
      ...
      const study = await initStudy(data.name || null, "interview", null, locale);
      studyId = study.id;
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          type={field.value ? "date" : startInputType}
                          className="w-fit"
                          placeholder={ti("startDatePlaceholder")}
                          {...field}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          type={field.value ? "date" : endInputType}
                          className="w-fit"
                          placeholder={ti("endDatePlaceholder")}
                          {...field}
              ...
              <div className="flex flex-col gap-2">
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-1 text-center">
                    ...
                    <span className="text-muted-foreground text-xs">
                      {tc("supportingDocsFormatsInterview", { max: props.uploadPolicy.maxSizeMb })}
                    </span>
                  </div>
                </div>
