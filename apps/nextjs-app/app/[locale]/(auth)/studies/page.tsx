...
import { ClaimCompanyAlert } from "@/apps/nextjs-app/app/[locale]/(auth)/studies/claim-company-alert";
import { EmptyState } from "@/apps/nextjs-app/app/[locale]/(auth)/studies/empty-state";
