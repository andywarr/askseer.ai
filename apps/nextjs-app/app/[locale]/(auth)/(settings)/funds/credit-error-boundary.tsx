...
class CreditErrorBoundaryInner extends Component<InnerProps, State> {
...
export function CreditErrorBoundary(props: Props) {
  const t = useTranslations("FundsSettings.errors");
  return <CreditErrorBoundaryInner t={t} {...props} />;
}
