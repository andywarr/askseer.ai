...
export default async function Page(props: { params: Promise<{ id: string; locale: string }> }) {
  ...
  const [study, bookmarkedStudyIds, shareInfo, t, tMeta] = await Promise.all([
    getQualitativeAnalysis(id, session.userId),
    getBookmarkedStudyIds(session.userId),
    getStudyShareInfo(id, session.userId),
    getTranslations({ locale, namespace: "AnalysisDetail" }),
      ...
      <div>
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>{t("breadcrumb.analysis")}</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <div className="mb-8 min-w-0 overflow-hidden rounded-lg bg-gray-100 p-6 text-sm">
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="max-w-40 truncate text-xs text-zinc-600">
                        {file.originalName || t("untitledFile")}
                      </span>
                    </a>
                  );
                },
          ...
          <div className="grid gap-4 text-sm text-zinc-600 sm:grid-cols-4">
            ...
            <div>
              <p className="font-semibold text-zinc-700">{tMeta("modifiedBy")}</p>
              <UserMetadataDisplay
            ...
            <div>
              <p className="font-semibold text-zinc-700">{tMeta("lastModified")}</p>
