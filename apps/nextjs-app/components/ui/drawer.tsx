...
>(({ className, children, direction = "bottom", ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 flex flex-col border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950",
        direction === "right"
          ? "inset-y-0 right-0 ml-24 h-full w-[480px] max-w-[90vw] rounded-l-[10px]"
