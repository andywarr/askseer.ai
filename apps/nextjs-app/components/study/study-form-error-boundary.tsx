...
/**
 * Error boundary for study forms (evaluation, walkthrough, etc.).
 * Catches errors and displays a user-friendly fallback UI.
 */
export class StudyFormErrorBoundary extends React.Component<
  ErrorBoundaryProps,
  ErrorBoundaryState
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo): void {
    console.error("Study form error:", error, errorInfo);
  }
