      ...
      {values.map((v, i) => (
            ...
            >
              ...
              <button
                type="button"
                aria-label="Remove"
        className="ml-2 rounded p-1 text-zinc-500 hover:text-zinc-900 opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-opacity"
                onClick={() => remove(i)}
              >
                <X className="h-4 w-4" />
              </button>
