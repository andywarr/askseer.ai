...
import { z } from "zod";
import { contactRequestSchema } from "@/apps/nextjs-app/lib/schema";
import { submitContactRequest } from "@/apps/nextjs-app/lib/action";
import {
  clientLogger,
  getEmailDomain,
      ...
      <Card className="mx-auto w-full max-w-2xl shadow-lg">
        <CardHeader className="space-y-4 p-8 text-center md:p-10">
          ...
          <CardDescription className="text-lg">
            Thank you for reaching out to Seer.
          </CardDescription>
        </CardHeader>
        <CardContent className="px-8 pb-10 text-center md:px-10">
          <p className="text-muted-foreground text-lg">
            A member of our team will respond within 1 business day. We&apos;ve
            also sent a confirmation email to your inbox.
          </p>
        </CardContent>
      </Card>
    );
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Enter your message here. Feel free to ask questions, share feedback, or tell us how we can help."
