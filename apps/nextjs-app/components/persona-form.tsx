...
// removed popover/command combobox imports as we now always use Google Places
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
// removed switch/label; Places is always enabled
...
// removed country/state preset arrays; we no longer use the manual picker
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="md:col-span-2">
                        ...
                        <FormControl>
                          <Textarea
                            placeholder="What prompts a decision?"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
