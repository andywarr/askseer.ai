...
export function getStudyCostCents(
  ...
  if (companyId) {
    ...
    if (studyType === "LIVE_SESSION") return COMPANY_LIVE_SESSION_COST_CENTS;
    if (studyType === "INTERVIEW") return COMPANY_INTERVIEW_COST_CENTS;
  ...
  if (studyType === "LIVE_SESSION") return PERSONAL_LIVE_SESSION_COST_CENTS;
  if (studyType === "INTERVIEW") return PERSONAL_INTERVIEW_COST_CENTS;
  if (studyType === "COGNITIVE_WALKTHROUGH")
