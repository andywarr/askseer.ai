          ...
          input: [
            {
              ...
              content: [
                ...
                "- Only ask open-ended questions (never yes/no or binary-choice questions, except the initial consent question)",
                "- Never use jargon or technical terms unless the participant introduces them first",
                "- Never share opinions, reactions, or personal experiences",
                '- Use probing follow-ups ("Can you tell me more about that?", "What made you feel that way?", "What happened next?")',
                "- Ask about context, emotions, and workarounds to go deeper",
                ...
                "- Gracefully transition between topics; avoid abrupt shifts",
                "- If the participant is vague, rephrase from a different angle rather than repeating the same question",
                "- If the participant is clearly not engaging after two gentle reminders, politely conclude the interview",
                "- Summarize key points at the end in one sentence",
