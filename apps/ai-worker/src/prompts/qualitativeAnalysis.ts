...
- Direct quotes from participants (verbatim when possible). You may use ellipses ('...') to join disjointed parts of a quote. Do NOT wrap the quote text in quotation marks.
...
2. **Merge, don't duplicate**: When multiple runs surface the same insight, merge them into the best-evidenced version. Pick the clearest observation, motivation, and implication. Combine supporting quotes from all runs (deduplicating exact duplicates). You may use ellipses ('...') to join disjointed parts of a quote. Do NOT wrap the quote text in quotation marks.
