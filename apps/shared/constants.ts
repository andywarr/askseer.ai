...
export const PERSONAL_ANALYZE_COST_CENTS = 1499; // $14.99
export const COMPANY_ANALYZE_COST_CENTS = 4499; // $44.99
...
export const PERSONAL_STUDY_COST_CENTS = PERSONAL_ANALYZE_COST_CENTS;
export const COMPANY_STUDY_COST_CENTS = COMPANY_ANALYZE_COST_CENTS;
