...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "dark:bg-zinc-950 relative flex min-h-svh flex-1 flex-col bg-white",
...
>(({ className, ...props }, ref) => {
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn(
        "focus-visible:ring-sidebar-ring dark:bg-zinc-950 h-8 w-full bg-white shadow-none focus-visible:ring-2",
        className,
      )}
      {...props}
    />
